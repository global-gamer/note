...
Pipeline für Experimente, die über klassische Phasenarbeit hinausgehen. Jedes Playbook orientiert sich an Hypothese → KPI → Verantwortliche → zugehörige Phase.
...
2. Playbook-Note anlegen (Struktur wie Taschengeld Funnel verwenden).
3. Phase Gate definieren (wann Pilot / Rollout stattfindet).
4. Ergebnis + Lessons Learned am Ende dokumentieren → Manifest & Meeting-Templates verlinken.

↩ [[Home\|Home]] · Verknüpft mit [[05_Phasenplan/Phase 7 Growth Sprint\|Phase 7 Growth Sprint]] & [[05_Phasenplan/Phase 8 Monetization\|Phase 8 Monetization]]
